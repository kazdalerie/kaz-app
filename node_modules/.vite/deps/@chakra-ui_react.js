...
function createUseRender(forwardMotionProps = false) {
  const useRender = (Component2, props, ref, { latestValues }, isStatic) => {
    ...
    const elementProps = Component2 !== import_react21.Fragment ? { ...filteredProps, ...visualProps, ref } : {};
...
var VisualElement = class {
  ...
  getBaseTarget(key) {
    ...
    const valueFromInitial = typeof initial === "string" || typeof initial === "object" ? (_b = resolveVariantFromProps(this.props, initial, (_a2 = this.presenceContext) === null || _a2 === void 0 ? void 0 : _a2.custom)) === null || _b === void 0 ? void 0 : _b[key] : void 0;
...
var createDomVisualElement = (Component2, options) => {
  return isSVGComponent(Component2) ? new SVGVisualElement(options, { enableHardwareAcceleration: false }) : new HTMLVisualElement(options, {
    allowProjection: Component2 !== import_react26.Fragment,
...
var AnimatePresence = ({ children, custom, initial = true, onExitComplete, exitBeforeEnter, presenceAffectsLayout = true, mode = "sync" }) => {
  ...
  return React4.createElement(React4.Fragment, null, exitingChildren.size ? childrenToRender : childrenToRender.map((child) => (0, import_react32.cloneElement)(child)));
};
...
var ToastComponent = (0, import_react53.memo)((props) => {
  const {
    id: id3,
    message,
    onCloseComplete,
  ...
  const [delay2, setDelay] = (0, import_react53.useState)(duration);
  ...
  const containerStyles = (0, import_react53.useMemo)(
    () => ({
      pointerEvents: "auto",
      maxWidth: 560,
      minWidth: 300,
  ...
  const toastStyle = (0, import_react53.useMemo)(() => getToastStyle(position2), [position2]);
...
function useDescendant(options) {
  ...
  const [index, setIndex] = (0, import_react58.useState)(-1);
...
var Breadcrumb = forwardRef(
  function Breadcrumb2(props, ref) {
    ...
    const clones = validChildren.map(
      (child, index) => (0, import_react74.cloneElement)(child, {
        separator,
        spacing,
...
var focusScope = (0, import_react93.createContext)(void 0);
...
var FocusLock = React17.forwardRef(function FocusLockUI(props, parentRef) {
  ...
  var _React$useState2 = React17.useState({}), update = _React$useState2[1];
  ...
  var _React$useState3 = React17.useState({}), id3 = _React$useState3[0];
  var onActivation = React17.useCallback(function(_ref2) {
  ...
  var focusScopeValue = React17.useMemo(function() {
    return {
      observed,
      shards,
      enabled: !disabled,
  ...
  return React17.createElement(React17.Fragment, null, hasLeadingGuards && [
    ...
    onBlur: onBlur3,
    onFocus: onFocus3
  }), React17.createElement(focusScope.Provider, {
...
var FocusLock2 = (props) => {
  ...
  const onActivation = (0, import_react97.useCallback)(() => {
  ...
  const onDeactivation = (0, import_react97.useCallback)(() => {
    var _a2;
...
function usePrevious(value) {
  const ref = (0, import_react98.useRef)();
...
var useSafeLayoutEffect3 = isBrowser ? import_react100.useLayoutEffect : import_react100.useEffect;

// ../../node_modules/@chakra-ui/hooks/dist/chunk-KA2477BY.mjs
var import_react101 = __toESM(require_react(), 1);
function useCallbackRef3(fn2, deps = []) {
  const ref = (0, import_react101.useRef)(fn2);
  useSafeLayoutEffect3(() => {
    ref.current = fn2;
  });
  return (0, import_react101.useCallback)((...args) => {
    var _a2;
...
function useWhyDidYouUpdate(name, props) {
  const previousProps = (0, import_react103.useRef)();
...
function useMouseDownRef(shouldListen = true) {
  const mouseDownRef = (0, import_react108.useRef)();
...
function usePanGesture(ref, props) {
  ...
  const panSession = (0, import_react111.useRef)(null);
  const handlers2 = {
...
function useId6(idProp, prefix) {
  const id3 = (0, import_react112.useId)();
...
function useOptionalPart(partId) {
  const [id3, setId] = (0, import_react112.useState)(null);
  const ref = (0, import_react112.useCallback)(
    (node2) => {
...
function useControllableState2(props) {
  ...
  const value = isControlled ? valueProp : valueState;
  const updateValue = (0, import_react113.useCallback)(
    (next) => {
...
function useDisclosure(props = {}) {
  ...
  const [isOpenState, setIsOpen] = (0, import_react114.useState)(props.defaultIsOpen || false);
  const [isControlled, isOpen] = useControllableProp(isOpenProp, isOpenState);
  const id3 = useId6(idProp, "disclosure");
  const onClose = (0, import_react114.useCallback)(() => {
    if (!isControlled) {
      setIsOpen(false);
    }
    onClosePropCallbackRef == null ? void 0 : onClosePropCallbackRef();
  }, [isControlled, onClosePropCallbackRef]);
  const onOpen = (0, import_react114.useCallback)(() => {
    if (!isControlled) {
      setIsOpen(true);
    }
    onOpenPropCallbackRef == null ? void 0 : onOpenPropCallbackRef();
  }, [isControlled, onOpenPropCallbackRef]);
  const onToggle = (0, import_react114.useCallback)(() => {
...
function useEventListenerMap() {
  const listeners = (0, import_react115.useRef)(/* @__PURE__ */ new Map());
  const currentListeners = listeners.current;
  const add = (0, import_react115.useCallback)((el, type, listener, options) => {
  ...
  const remove = (0, import_react115.useCallback)(
...
var useUpdateEffect2 = (effect5, deps) => {
  const renderCycleRef = (0, import_react116.useRef)(false);
  const effectCycleRef = (0, import_react116.useRef)(false);
...
function useFocusOnShow(target, options = defaultOptions2) {
  ...
  const autoFocusRef = (0, import_react117.useRef)(autoFocusValue);
  const lastVisibleRef = (0, import_react117.useRef)(visible);
  useSafeLayoutEffect3(() => {
  ...
  const onFocus3 = (0, import_react117.useCallback)(() => {
...
function useForceUpdate2() {
  const unloadingRef = (0, import_react118.useRef)(false);
  const [count, setCount] = (0, import_react118.useState)(0);
  useUnmountEffect2(() => {
...
function useAnimationState(props) {
  ...
  const [mounted, setMounted] = (0, import_react119.useState)(isOpen);
  const [once, setOnce] = (0, import_react119.useState)(false);
...
function useBoolean(initialState2 = false) {
  const [value, setValue] = (0, import_react120.useState)(initialState2);
  const callbacks = (0, import_react120.useMemo)(
    () => ({
      on: () => setValue(true),
      off: () => setValue(false),
...
function useClipboard(value, optionsOrTimeout = {}) {
  const [hasCopied, setHasCopied] = (0, import_react121.useState)(false);
  const [valueState, setValueState] = (0, import_react121.useState)(value);
  (0, import_react121.useEffect)(() => setValueState(value), [value]);
...
function useDimensions(ref, observe) {
  const [dimensions, setDimensions] = (0, import_react123.useState)(null);
  const rafId = (0, import_react123.useRef)();
  useSafeLayoutEffect3(() => {
    function measure() {
      const node2 = ref.current;
      if (!node2)
...
var InputGroup = forwardRef(
  function InputGroup2(props, ref) {
    ...
    const clones = validChildren.map((child) => {
      ...
      return child.type.id !== "Input" ? (0, import_react124.cloneElement)(child, theming) : (0, import_react124.cloneElement)(child, Object.assign(theming, groupStyles, child.props));
    });
...
var Wrap = forwardRef(function Wrap2(props, ref) {
  ...
  const _children = (0, import_react125.useMemo)(
    () => shouldWrapChildren ? import_react125.Children.map(children, (child, index) => (0, import_jsx_runtime71.jsx)(WrapItem, { children: child }, index)) : children,
...
var Stack = forwardRef((props, ref) => {
  ...
  const clones = (0, import_react126.useMemo)(() => {
    ...
    return shouldUseChildren ? validChildren : validChildren.map((child, index) => {
      ...
      return (0, import_jsx_runtime74.jsxs)(import_react126.Fragment, { children: [
        _child,
        _divider
      ] }, key);
    });
...
function useHighlight(props) {
  ...
  return (0, import_react127.useMemo)(() => highlightWords({ text, query }), [text, query]);
}
...
function Highlight(props) {
  ...
  return (0, import_jsx_runtime80.jsx)(import_jsx_runtime80.Fragment, { children: chunks.map((chunk, index) => {
    return chunk.match ? (0, import_jsx_runtime80.jsx)(Mark, { sx: styles, children: chunk.text }, index) : (0, import_jsx_runtime80.jsx)(import_react127.Fragment, { children: chunk.text }, index);
  }) });
}
...
var AspectRatio = forwardRef(function(props, ref) {
  ...
  const child = import_react129.Children.only(children);
...
function useMediaQuery(query, options = {}) {
  ...
  const [value, setValue] = (0, import_react130.useState)(() => {
...
function useShortcut2(props = {}) {
  const { timeout = 300, preventDefault = () => true } = props;
  const [keys, setKeys] = (0, import_react131.useState)([]);
  const timeoutRef = (0, import_react131.useRef)();
  const flush = () => {
    if (timeoutRef.current) {
      clearTimeout(timeoutRef.current);
      timeoutRef.current = null;
  ...
  (0, import_react131.useEffect)(() => flush, []);
  function onKeyDown(fn2) {
    return (event) => {
      if (event.key === "Backspace") {
        const keysCopy = [...keys];
...
function useEventListeners() {
  const listeners = (0, import_react132.useRef)(/* @__PURE__ */ new Map());
  const currentListeners = listeners.current;
  const add = (0, import_react132.useCallback)((el, type, listener, options) => {
    listeners.current.set(listener, { type, el, options });
    el.addEventListener(type, listener, options);
  }, []);
  const remove = (0, import_react132.useCallback)(
    (el, type, listener, options) => {
...
function useClickable(props = {}) {
  ...
  const [isButton, setIsButton] = (0, import_react133.useState)(true);
  const [isPressed, setIsPressed] = (0, import_react133.useState)(false);
  ...
  const onDocumentKeyUp = (0, import_react133.useCallback)(
    (e) => {
  ...
  const handleKeyDown = (0, import_react133.useCallback)(
    (event) => {
  ...
  const handleKeyUp = (0, import_react133.useCallback)(
    (event) => {
  ...
  const onDocumentMouseUp = (0, import_react133.useCallback)(
    (event) => {
      if (event.button !== 0)
        return;
      setIsPressed(false);
  ...
  const handleMouseDown = (0, import_react133.useCallback)(
    (event) => {
      if (event.button !== 0)
        return;
      if (isDisabled2) {
  ...
  const handleMouseUp = (0, import_react133.useCallback)(
    (event) => {
      if (event.button !== 0)
        return;
      if (!isButton) {
  ...
  const handleMouseOver = (0, import_react133.useCallback)(
    (event) => {
      if (isDisabled2) {
        event.preventDefault();
        return;
  ...
  const handleMouseLeave = (0, import_react133.useCallback)(
    (event) => {
      if (isPressed) {
        event.preventDefault();
        setIsPressed(false);
...
function useFocusOnShow2(target, options = defaultOptions3) {
  ...
  const autoFocusValue = shouldFocus && visible;
  const autoFocusRef = (0, import_react134.useRef)(autoFocusValue);
  const lastVisibleRef = (0, import_react134.useRef)(visible);
  useSafeLayoutEffect(() => {
    if (!lastVisibleRef.current && visible) {
      autoFocusRef.current = autoFocusValue;
    }
...
function usePopper(props = {}) {
  ...
  const reference2 = (0, import_react135.useRef)(null);
  const popper2 = (0, import_react135.useRef)(null);
  const instance = (0, import_react135.useRef)(null);
  const placement = getPopperPlacement(placementProp, direction);
  const cleanup = (0, import_react135.useRef)(() => {
  });
  const setupPopper = (0, import_react135.useCallback)(() => {
    var _a2;
  ...
  const referenceRef = (0, import_react135.useCallback)(
    (node2) => {
  ...
  const getReferenceProps = (0, import_react135.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
  ...
  const popperRef = (0, import_react135.useCallback)(
    (node2) => {
  ...
  const getPopperProps = (0, import_react135.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
  ...
  const getArrowProps = (0, import_react135.useCallback)((props2 = {}, ref = null) => {
  ...
  const getArrowInnerProps = (0, import_react135.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
      ref,
      "data-popper-arrow-inner": ""
...
function useDisclosure2(props = {}) {
  ...
  const [isOpenState, setIsOpen] = (0, import_react136.useState)(props.defaultIsOpen || false);
  const isOpen = isOpenProp !== void 0 ? isOpenProp : isOpenState;
  const isControlled = isOpenProp !== void 0;
  const uid = (0, import_react136.useId)();
  const id3 = idProp != null ? idProp : `disclosure-${uid}`;
  const onClose = (0, import_react136.useCallback)(() => {
    if (!isControlled) {
      setIsOpen(false);
    }
    handleClose == null ? void 0 : handleClose();
  }, [isControlled, handleClose]);
  const onOpen = (0, import_react136.useCallback)(() => {
    if (!isControlled) {
      setIsOpen(true);
    }
    handleOpen == null ? void 0 : handleOpen();
  }, [isControlled, handleOpen]);
  const onToggle = (0, import_react136.useCallback)(() => {
    if (isOpen) {
      onClose();
    } else {
      onOpen();
...
function useAnimationState2(props) {
  const { isOpen, ref } = props;
  const [mounted, setMounted] = (0, import_react138.useState)(isOpen);
  const [once, setOnce] = (0, import_react138.useState)(false);
...
function useMenu(props = {}) {
  ...
  const menuRef = (0, import_react139.useRef)(null);
  const buttonRef = (0, import_react139.useRef)(null);
  const descendants = useMenuDescendants();
  const focusMenu = (0, import_react139.useCallback)(() => {
    requestAnimationFrame(() => {
      var _a2;
      (_a2 = menuRef.current) == null ? void 0 : _a2.focus({ preventScroll: false });
    });
  }, []);
  const focusFirstItem = (0, import_react139.useCallback)(() => {
  ...
  const focusLastItem = (0, import_react139.useCallback)(() => {
    const id22 = setTimeout(() => {
      const last = descendants.lastEnabled();
      if (last)
  ...
  const onOpenInternal = (0, import_react139.useCallback)(() => {
  ...
  const [focusedIndex, setFocusedIndex] = (0, import_react139.useState)(-1);
  useUpdateEffect(() => {
    if (!isOpen) {
      setFocusedIndex(-1);
    }
  ...
  const openAndFocusMenu = (0, import_react139.useCallback)(() => {
    onOpen();
    focusMenu();
  }, [onOpen, focusMenu]);
  const timeoutIds = (0, import_react139.useRef)(/* @__PURE__ */ new Set([]));
  ...
  const openAndFocusFirstItem = (0, import_react139.useCallback)(() => {
    onOpen();
    focusFirstItem();
  }, [focusFirstItem, onOpen]);
  const openAndFocusLastItem = (0, import_react139.useCallback)(() => {
    onOpen();
    focusLastItem();
  }, [onOpen, focusLastItem]);
  const refocus = (0, import_react139.useCallback)(() => {
    var _a2, _b;
  ...
  const rafId = (0, import_react139.useRef)(null);
  return {
    openAndFocusMenu,
...
function useMenuButton(props = {}, externalRef = null) {
  ...
  const onKeyDown = (0, import_react139.useCallback)(
    (event) => {
      const eventKey = event.key;
      const keyMap = {
...
function useMenuList(props = {}, ref = null) {
  ...
  const hasBeenOpened = (0, import_react139.useRef)(false);
  if (isOpen) {
...
function useMenuItem(props = {}, externalRef = null) {
  ...
  const ref = (0, import_react139.useRef)(null);
  const id3 = `${menuId}-menuitem-${(0, import_react139.useId)()}`;
  const { index, register } = useMenuDescendant({
    disabled: isDisabled2 && !isFocusable2
  });
  const onMouseEnter = (0, import_react139.useCallback)(
    (event) => {
  ...
  const onMouseMove = (0, import_react139.useCallback)(
    (event) => {
  ...
  const onMouseLeave = (0, import_react139.useCallback)(
    (event) => {
  ...
  const onClick = (0, import_react139.useCallback)(
    (event) => {
  ...
  const onFocus3 = (0, import_react139.useCallback)(
    (event) => {
...
function useMenuOptionGroup(props = {}) {
  ...
  const onChange = (0, import_react139.useCallback)(
    (selectedValue) => {
...
var Menu = (props) => {
  ...
  const context = (0, import_react140.useMemo)(() => ctx, [ctx]);
...
var StyledMenuItem = forwardRef(
  (props, ref) => {
    ...
    const buttonStyles = (0, import_react141.useMemo)(
      () => ({
        textDecoration: "none",
        color: "inherit",
        userSelect: "none",
...
var MenuIcon = (props) => {
  ...
  const styles = useMenuStyles();
  const child = import_react142.Children.only(children);
  const clone = (0, import_react142.isValidElement)(child) ? (0, import_react142.cloneElement)(child, {
    focusable: "false",
    "aria-hidden": true,
...
var ModalTransition = (0, import_react143.forwardRef)(
  (props, ref) => {
...
function useModalManager(ref, isOpen) {
  const [index, setIndex] = (0, import_react144.useState)(0);
...
function useModal(props) {
  ...
  const dialogRef = (0, import_react145.useRef)(null);
  ...
  const mouseDownTarget = (0, import_react145.useRef)(null);
  const onMouseDown = (0, import_react145.useCallback)((event) => {
    mouseDownTarget.current = event.target;
  }, []);
  const onKeyDown = (0, import_react145.useCallback)(
    (event) => {
      if (event.key === "Escape") {
        event.stopPropagation();
        if (closeOnEsc) {
  ...
  const getDialogProps = (0, import_react145.useCallback)(
    (props2 = {}, ref = null) => ({
      role: "dialog",
      ...props2,
  ...
  const onOverlayClick = (0, import_react145.useCallback)(
    (event) => {
      event.stopPropagation();
  ...
  const getDialogContainerProps = (0, import_react145.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
...
function useNumberInput(props = {}) {
  ...
  const parse3 = (0, import_react152.useCallback)(
    (value) => {
      var _a2;
...
function PinInput(props) {
  ...
  const clones = getValidChildren(children).map(
    (child) => (0, import_react155.cloneElement)(child, { __css: styles })
  );
...
function PopoverTrigger(props) {
  ...
  return (0, import_react156.cloneElement)(child, getTriggerProps(child.props, child.ref));
}
...
function usePopover(props = {}) {
  ...
  const anchorRef = (0, import_react157.useRef)(null);
  const triggerRef = (0, import_react157.useRef)(null);
  const popoverRef = (0, import_react157.useRef)(null);
  const isHoveringRef = (0, import_react157.useRef)(false);
  const hasBeenOpened = (0, import_react157.useRef)(false);
  if (isOpen) {
    hasBeenOpened.current = true;
  }
  const [hasHeader, setHasHeader] = (0, import_react157.useState)(false);
  const [hasBody, setHasBody] = (0, import_react157.useState)(false);
  ...
  const getPopoverProps = (0, import_react157.useCallback)(
    (props2 = {}, _ref2 = null) => {
      const popoverProps = {
        ...props2,
        style: {
  ...
  const getPopoverPositionerProps = (0, import_react157.useCallback)(
  ...
  const getAnchorProps = (0, import_react157.useCallback)(
    (props2, _ref2 = null) => {
      return {
        ...props2,
  ...
  const openTimeout = (0, import_react157.useRef)();
  const closeTimeout = (0, import_react157.useRef)();
  const maybeReferenceRef = (0, import_react157.useCallback)(
    (node2) => {
  ...
  const getTriggerProps = (0, import_react157.useCallback)(
    (props2 = {}, _ref2 = null) => {
      const triggerProps = {
        ...props2,
  ...
  const getHeaderProps = (0, import_react157.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
      id: headerId,
  ...
  const getBodyProps = (0, import_react157.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
      id: bodyId,
      ref: mergeRefs(ref, (node2) => {
...
function PopoverAnchor(props) {
  ...
  return (0, import_react158.cloneElement)(child, getAnchorProps(child.props, child.ref));
}
...
function useRadioGroup(props = {}) {
  ...
  const [valueState, setValue] = (0, import_react159.useState)(defaultValue || "");
  const isControlled = typeof valueProp !== "undefined";
  const value = isControlled ? valueProp : valueState;
  const ref = (0, import_react159.useRef)(null);
  const focus2 = (0, import_react159.useCallback)(() => {
  ...
  const onChange = (0, import_react159.useCallback)(
    (eventOrValue) => {
...
var RadioGroup = forwardRef((props, ref) => {
  ...
  const group = (0, import_react160.useMemo)(
    () => ({
      name,
      size,
      onChange,
...
function useRadio(props = {}) {
  ...
  const uuid = `radio-${(0, import_react161.useId)()}`;
  ...
  const [isFocusVisible2, setIsFocusVisible] = (0, import_react161.useState)(false);
  const [isFocused, setFocused] = (0, import_react161.useState)(false);
  const [isHovered, setHovering] = (0, import_react161.useState)(false);
  const [isActive, setActive] = (0, import_react161.useState)(false);
  const [isCheckedState, setChecked] = (0, import_react161.useState)(Boolean(defaultChecked));
  ...
  const onKeyUp = (0, import_react161.useCallback)(
    (event) => {
      if (event.key === " ") {
        setActive(false);
      }
...
var SelectIcon = (props) => {
  ...
  const clone = (0, import_react162.cloneElement)(children, {
    role: "presentation",
  ...
  return (0, import_jsx_runtime135.jsx)(IconWrapper, { ...rest, className: "chakra-select__icon-wrapper", children: (0, import_react162.isValidElement)(children) ? clone : null });
};
...
function useIsFirstRender() {
  const isFirstRender = (0, import_react163.useRef)(true);
...
function usePrevious2(value) {
  const ref = (0, import_react164.useRef)();
...
var SkipNavLink = forwardRef(
  function SkipNavLink2(props, ref) {
    ...
    return (0, import_jsx_runtime139.jsx)(chakra.a, { ...rest, ref, href: `#${id3}`, __css: getStyles2(styles) });
  }
);
...
function usePanEvent(ref, options) {
  ...
  const panSession = (0, import_react166.useRef)(null);
...
var useSafeLayoutEffect4 = Boolean(globalThis == null ? void 0 : globalThis.document) ? import_react167.useLayoutEffect : import_react167.useEffect;
...
function useSizes({
  ...
  const [sizes, setSizes] = (0, import_react167.useState)([]);
  const [count, setCount] = (0, import_react167.useState)(0);
...
function useRangeSlider(props) {
  ...
  const getOutputProps = (0, import_react168.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
        ref,
...
var RangeSlider = forwardRef(
  function RangeSlider2(props, ref) {
    ...
    const ctx = (0, import_react169.useMemo)(
...
function useSlider(props) {
  ...
  const thumbRef = (0, import_react170.useRef)(null);
  ...
  const constrain = (0, import_react170.useCallback)(
    (value2) => {
      const state2 = stateRef.current;
...
var Stepper = forwardRef(function Stepper2(props, ref) {
  ...
  const stepElements = import_react171.Children.toArray(children);
...
function useSteps(props = {}) {
  ...
  const [activeStep, setActiveStep] = (0, import_react172.useState)(index);
...
var Switch = forwardRef(function Switch2(props, ref) {
  ...
  const containerStyles = (0, import_react173.useMemo)(
    () => ({
      display: "inline-block",
      position: "relative",
      verticalAlign: "middle",
  ...
  const trackStyles = (0, import_react173.useMemo)(
    () => ({
      display: "inline-flex",
      flexShrink: 0,
  ...
  const labelStyles = (0, import_react173.useMemo)(
    () => ({
      userSelect: "none",
      marginStart: spacing,
      ...styles.label
...
function useTabs(props) {
  ...
  const [focusedIndex, setFocusedIndex] = (0, import_react174.useState)(defaultIndex != null ? defaultIndex : 0);
...
function useTabPanels(props) {
  ...
  const children = validChildren.map(
    (child, index) => (0, import_react174.createElement)(
      TabPanelProvider,
      {
        key: index,
        value: {
...
function useTabPanel(props) {
  ...
  const hasBeenSelected = (0, import_react174.useRef)(false);
  if (isSelected) {
...
function useTabIndicator() {
  ...
  const isHorizontal = orientation === "horizontal";
  const isVertical = orientation === "vertical";
  const [rect, setRect] = (0, import_react174.useState)(() => {
    if (isHorizontal)
  ...
  const [hasMeasured, setHasMeasured] = (0, import_react174.useState)(false);
  useSafeLayoutEffect(() => {
...
var Tabs = forwardRef(function Tabs2(props, ref) {
  ...
  const context = (0, import_react175.useMemo)(() => ctx, [ctx]);
